...
//                (const unsigned char**)openGLletters,"SSAGE",
//                0,0,true);
////    LCDLibrary::drawString(
//                m_app->getScreenData(),m_app->getScreenWidth(),m_app->getScreenHeight(),
//                (const unsigned char**)openGLletters,"CAL",
//                0,0,false);
//    clearDisplay();
//    LCDLibrary::drawString(
//                m_app->getScreenData(),m_app->getScreenWidth(),m_app->getScreenHeight(),
...
//    LCDLibrary::drawChar(
//                m_app->getScreenData(),m_app->getScreenWidth(),m_app->getScreenHeight(),
//                (const unsigned char**)openGLletters,'C',
//                0,0,false);
//    LCDLibrary::drawChar(
//                m_app->getScreenData(),m_app->getScreenWidth(),m_app->getScreenHeight(),
//                (const unsigned char**)openGLletters,'C',
...
//    LCDLibrary::drawChar(
//                m_app->getScreenData(),m_app->getScreenWidth(),m_app->getScreenHeight(),
//                (const unsigned char**)openGLletters,'A',
//                0,0,false);
//    LCDLibrary::drawChar(
//                m_app->getScreenData(),m_app->getScreenWidth(),m_app->getScreenHeight(),
//                (const unsigned char**)openGLletters,'A',
...
//    clearDisplay();
    ...
    if(m_app->buttonState(BUTTON_ID::BTN_ENTER) == BUTTON_STATE::BUTTON_PRESS) {
        switch (m_currentID) {
        case MENU_ID::MENU_GAME:
        {
            m_app->setMachineState(MACHINE_STATE::MACHINE_ENTER_GAME);
            break;
        }
        case MENU_ID::MENU_CALL:
        {
            m_app->setMachineState(MACHINE_STATE::MACHINE_ENTER_CALL);
            break;
        }
        case MENU_ID::MENU_CONTACTS:
        {
            m_app->setMachineState(MACHINE_STATE::MACHINE_ENTER_CONTACTS);
            break;
        }
        case MENU_ID::MENU_MESSAGE:
        {
            m_app->setMachineState(MACHINE_STATE::MACHINE_ENTER_MESSAGE);
            break;
        }
        }
...
void MainMenu::drawScrollBar() {
    ...
    LCDLibrary::drawRect(m_app->getScreenData(),m_app->getScreenWidth(),m_app->getScreenHeight(),
                         ...
                         5,m_app->getScreenHeight()/(MENU_MAX - MENU_MIN-1),1,true);
}
